  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('posts/'); ?>"><?php echo $this->session->userdata('employeeid'); ?></a>
      </li>
      ...
      <li>
        <a class="nav-link" href="<?php echo base_url('Posts/logout'); ?>"/>Log out</a></li>
    </ul>
